...
mixin _$HomeState {
  ...
  List<HotAndNewData> get pastYearMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get tendingMovieList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> tendingMovieList,
...
class _$HomeStateCopyWithImpl<$Res, $Val extends HomeState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      tendingMovieList: null == tendingMovieList
          ? _value.tendingMovieList
          : tendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<HotAndNewData> tendingMovieList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        _tendingMovieList = tendingMovieList,
  ...
  final List<HotAndNewData> _tendingMovieList;
  @override
  List<HotAndNewData> get tendingMovieList {
    if (_tendingMovieList is EqualUnmodifiableListView)
      return _tendingMovieList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_tendingMovieList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, tendingMovieList: $tendingMovieList, tenseDramaMovieList: $tenseDramaMovieList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._tendingMovieList, _tendingMovieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_tendingMovieList),
